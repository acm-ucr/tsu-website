  ...
  return (
    <div className="bg-tsu-beige-200 flex flex-col items-center justify-center gap-2 sm:flex-row sm:gap-5 sm:px-10 sm:py-6">
      <Image
        src={TSULogo}
        alt="TSU Logo"
        className="mt-5 flex w-25 flex-shrink-0 sm:mt-0 sm:w-[12%]"
      />
      ...
      <div className="font-tsu-sahitya mb-3 flex items-center gap-5 text-xl font-medium sm:mb-0 xl:ml-10 xl:gap-10 xl:text-3xl 2xl:text-4xl">
